...
export default function sitemap(): MetadataRoute.Sitemap {
  const staticRoutes = ["", "/funnels", "/funnels/fit-7", "/start-project", "/case-studies/northforge-internal-build", "/feedback", "/feedback/project", "/feedback/website", "/privacy", "/terms", "/intellectual-property"]
  return [
