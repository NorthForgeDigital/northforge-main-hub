...
const socialLinks = [
  ...
  { href: "https://www.linkedin.com/company/northforgedigitalsolutions/", icon: LinkedinIcon, label: "LinkedIn" },
          ...
          <div className="flex items-center gap-3">
            {socialLinks.map((social) => (
              <a
                ...
                className="w-9 h-9 rounded-full border border-border bg-card flex items-center justify-center text-muted-foreground hover:text-primary hover:border-primary/50 hover:scale-110 transition-all duration-200"
                aria-label={`Visit NorthForge on ${social.label}`}
              >
